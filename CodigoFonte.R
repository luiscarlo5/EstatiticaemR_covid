...
axis(2)
mtext(side = 1, line = 3, "2021")
mtext(side = 2, line = 3, "Número de pessoas", las = 2)

plot(df_afeganistao_casos_3onda$date, df_afeganistao_casos_3onda$new_deaths_smoothed, 
     type = "l", xlab = "Número de pessoas", ylab = "2021", 
     main = "Número de novas mortes suavizado (3° onda)")
...
#####################################################################33
# Testes de Hipótestes
# .......Hipótese nula: H0 = (Media de novas mortes = media_NM)
# Hipótese alternativa: H1 = (Media de novas mortes > media_NM)
...
# 153 é o numero de dias entre as duas ondas em
# análise (5 meses: maio até setembro)
